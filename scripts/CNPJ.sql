...
COPY cnae FROM 'C:\\Temp\\bases\\cnae.csv' WITH (FORMAT csv, DELIMITER ';', HEADER false, ENCODING 'UTF8');
...
COPY municipios FROM 'C:\\Temp\\bases\\municipios.csv' WITH (FORMAT csv, DELIMITER ';', HEADER false, ENCODING 'UTF8');
...
COPY estabelecimentos FROM 'C:\\Temp\\bases\\estabelecimentos_0.csv' WITH (FORMAT csv, DELIMITER ';', HEADER false, IGNORE_ERRORS true);
COPY estabelecimentos FROM 'C:\\Temp\\bases\\estabelecimentos_1.csv' WITH (FORMAT csv, DELIMITER ';', HEADER false, IGNORE_ERRORS true);
COPY estabelecimentos FROM 'C:\\Temp\\bases\\estabelecimentos_2.csv' WITH (FORMAT csv, DELIMITER ';', HEADER false, IGNORE_ERRORS true);
COPY estabelecimentos FROM 'C:\\Temp\\bases\\estabelecimentos_3.csv' WITH (FORMAT csv, DELIMITER ';', HEADER false, IGNORE_ERRORS true);
COPY estabelecimentos FROM 'C:\\Temp\\bases\\estabelecimentos_4.csv' WITH (FORMAT csv, DELIMITER ';', HEADER false, IGNORE_ERRORS true);
COPY estabelecimentos FROM 'C:\\Temp\\bases\\estabelecimentos_5.csv' WITH (FORMAT csv, DELIMITER ';', HEADER false, IGNORE_ERRORS true);
COPY estabelecimentos FROM 'C:\\Temp\\bases\\estabelecimentos_6.csv' WITH (FORMAT csv, DELIMITER ';', HEADER false, IGNORE_ERRORS true);
COPY estabelecimentos FROM 'C:\\Temp\\bases\\estabelecimentos_7.csv' WITH (FORMAT csv, DELIMITER ';', HEADER false, IGNORE_ERRORS true);
COPY estabelecimentos FROM 'C:\\Temp\\bases\\estabelecimentos_8.csv' WITH (FORMAT csv, DELIMITER ';', HEADER false, IGNORE_ERRORS true);
COPY estabelecimentos FROM 'C:\\Temp\\bases\\estabelecimentos_9.csv' WITH (FORMAT csv, DELIMITER ';', HEADER false, IGNORE_ERRORS true);
